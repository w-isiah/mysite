...
-- Table: assign_assessor
CREATE TABLE `assign_assessor` (
  `id` text,
  `assessor_id` text,
  `student_id` text,
  `assigned_by` text,
...
-- Table: d_external_assign_assessor
...
-- Table: d_internal_assign_assessor
...
-- Table: m_assign_assessor
CREATE TABLE `m_assign_assessor` (
  `id` text,
  `assessor_id` text,
  `student_id` text,
  `assigned_by` text,
...
-- Table: mudulate_marks
CREATE TABLE `mudulate_marks` (
  `mark_id` text,
  `student_id` text,
  `term_id` text,
  `assessor_id` text,
...
INSERT INTO student_info (id, student_teacher, programme_id, reg_no, subject, term_id, class_name, topic, subtopic, teaching_time, school_id, academic_year_id, study_year_id) VALUES (NULL, '', '1', '18/U/ITE/17889/PE', NULL, '4', NULL, NULL, NULL, NULL, '3', '7', '5');
...
INSERT INTO users (id, username, password, role, first_name, last_name, other_name, profile_image, a_internal_role, a_external_role) VALUES ('28', 'keno', 'pbkdf2:sha256:600000$MZxi2rzKC6HBOcKr$2a78242d244992f620e99daad76c45d4f0da787181cf3ee60db7ac5d1d153c6a', 'School Practice Supervisor', 'Lubega', 'Kennedy', 'Kyazze', 'uploadsgloria.png', NULL, NULL);
